  ...
  stages{
    ...
    stage('Unit Tests') {
        steps{
            ...
            sh "xcodebuild -project CeibaAdn-Parking.xcodeproj -scheme CeibaAdn-Parking -sdk iphonesimulator -destination 'platform=iOS Simulator,name=iPhone 8,OS=14.5' test |  -r junit --output build/reports/junit.xml"
        }
    }
